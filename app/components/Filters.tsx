...
function Filters() {
  ...
  return (
    <div className='bg-[#36454F] lg:w-[60%] mx-auto lg:mb-[2em] w-full h-[3em] rounded-[1em]'>
      <div className='backdrop-blur-md rounded-[inherit] justify-between px-[1em] flex items-center bg-white/50 w-full h-full'>
